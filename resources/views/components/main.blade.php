<div class="flex flex-col min-w-0 flex-1 overflow-hidden">
    <div class="lg:hidden print:hidden">
        <div class="flex items-center justify-between bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-900 px-4 py-1.5">
            <div>
                <a href="{{ route('home') }}">
                    <img class="h-8 w-auto dark:hidden" src="https://write.mv/images/logo-dark-bg.svg" alt="Writemv">
                    <img class="h-8 w-auto hidden dark:inline" src="https://write.mv/images/logo.svg" alt="Writemv">
                </a>
            </div>
            <div>
                <button
